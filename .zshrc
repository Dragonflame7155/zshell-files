...
#→ '
PS1='%F{134}%f%K{134}%n@%m %k%F{134}%K{241}%f %F{241}%k%K{black}%f%F{134} %~ %f%k%F{black}%f'
RPS1='%F{black}%f%K{black} %F{green}%(?.✓.[%?] ) %F{241}%k%k%f%K{241} $(__git_ps1 " %s ")%F{134}%K{241}%k%f%K{134}%T %H%D%Y%k%F{134}%f'
PS2='%F{134}%f%K{134}%_%k%K{241}%F{134}%f%k%K{black}%F{241}%f%k%F{black}%f'
alias dragonflame="ascii-image-converter ~/.image.png -W 50 --braille --threshold 30"
